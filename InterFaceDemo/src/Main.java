...
public class Main {
  public static void main(String[] args) {
    ...
    ISaveable value = new Player("jason", 100, 200);

    List<String> savedData = value.write();

    ISaveable loadData = new Player();


//    int size = savedData.size();

//    System.out.println(size);



  ISaveable werewolf = new Monster("Werewolf", 20, 40, "axe");

  System.out.println("Strength = "+((Monster)werewolf).getMonsterStrength());
